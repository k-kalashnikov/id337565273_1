...
{
    public class CreateContractNotification : INotification
    {
        public CreateContractNotification(Guid id, Guid? parent, int contractStatusId, int contractTypeId, long customerOrganizationId, long contractorOrganizationId, string number, DateTime startDate, DateTime finishDate, bool? signedByCustomer, bool? signedByContractor)
        {
            Id = id;
            Parent = parent;
