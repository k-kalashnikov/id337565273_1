...
namespace SP.Contract.Infrastructure.Extensions
{
    ...
    {
        // Мастер-пользователь
        public const string SuperuserMnemonic = "superuser.module.platform";

        // Категорийный менеджер
        public const string ManagerMnemonic = "manager.module.market";
        ...
        // Поставщик
        public const string ContractorPlatformMnemonic = "contractor.module.platform";
